        ...
        <div className="bg-white/[0.02] dark:bg-black/10 backdrop-blur-sm border border-black/[0.05] dark:border-white/10 shadow-2xl rounded-[2.5rem] overflow-hidden p-8 sm:p-10 relative">
          ...
          <div className="flex flex-col items-center mb-8 space-y-4">
            ...
            <div className="text-center space-y-1">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white tracking-tight">Bem-vindo</h2>
              <p className="text-zinc-500 dark:text-zinc-400 text-sm font-medium">Acesse sua conta no AmaroTube</p>
            </div>
          </div>
